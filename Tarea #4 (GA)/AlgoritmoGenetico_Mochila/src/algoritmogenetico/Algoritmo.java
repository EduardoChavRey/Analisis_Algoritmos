...
public class Algoritmo {
    ...
    public static Poblacion evolucionarPoblacion(Poblacion pop) {
        Poblacion newPoblacion = new Poblacion(pop.size(),pop.getIndividuo(0).getObjetos(), false);
    ...
    private static Individuo cruce(Individuo indiv1, Individuo indiv2) {
        ...
        // Loop through genes
        newSol.generarIndividuo(indiv1.getObjetos());
    ...
    private static Individuo torneoSeleccion(Poblacion pop) {
        ...
        Poblacion torneo = new Poblacion(torneoSize,pop.getIndividuo(0).getObjetos(), false);
